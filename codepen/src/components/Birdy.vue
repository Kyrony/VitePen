...
<article>
    ...
    <div class="birds">
	    <h1 id="bird1">Birds, </h1><h1 id="bird2"> Birds, </h1><h1 id="bird3"> Birds!</h1>
    </div>
    <img src="https://images.unsplash.com/photo-1642369903283-0dbfb3015613?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTY0ODkzOTU1MA&ixlib=rb-1.2.1&q=85" alt="a red cardinal perched on a bare tree branch. " title="Photo by Prazanthy Ramesh for Unsplash" class="hero-image">

	<h2>You Gotta Love Birds</h2>
	...
	<img src="https://images.unsplash.com/photo-1601168049797-351a4abb0b2f?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTY1MDY1NDk3Nw&ixlib=rb-1.2.1&q=85" alt="a green hummingbird flying among yellow flowers" title="Photo by Geronimo Giqueaux for Unsplash" class="editorial-image-right">
    ...
    <hr>
	<h2>Flapping Around, Flying All Over</h2>
	<p>Donec imperdiet efficitur risus in venenatis. Aenean ornare iaculis orci a condimentum. Praesent tincidunt, purus ac placerat posuere, lacus risus suscipit lacus, et sollicitudin turpis metus in enim. Vestibulum at imperdiet magna, ac vehicula magna. Praesent placerat sapien bibendum, faucibus lectus at, euismod elit. Nunc velit est, faucibus et faucibus eu, tempus non nisi. Fusce hendrerit auctor lectus non auctor. Vestibulum luctus metus eget sapien volutpat congue. Fusce eget augue mauris. Ut egestas mi et feugiat sagittis. Cras ac convallis elit.</p>
	<img src="https://images.unsplash.com/photo-1574068468668-a05a11f871da?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTY0ODkzOTc5OA&ixlib=rb-1.2.1&q=85" alt="A hummingbird flying among yellow flowers. " title="Photo by Deepak Nautiyal for Unsplash" class="editorial-image-left">
	...
	<img src="https://images.unsplash.com/photo-1602426172655-f97717c8d8e4?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTY1MDY1NTQ1MA&ixlib=rb-1.2.1&q=85" alt="A robin perched on a tree branch. " title="Photo by Alfred Kenneally for Unsplash" class="editorial-image-right">
	...
	<p>Nam tincidunt vel risus et dictum. Quisque efficitur quam vel libero pellentesque interdum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed iaculis ligula ut aliquam aliquet. Vivamus vel elementum lectus. Interdum et malesuada fames ac ante ipsum primis in faucibus. Quisque vel erat leo. Donec rhoncus nec orci eget rutrum.</p>
    <hr>
	<h2>Singing Little Songs, Looking Fancy</h2>
	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus imperdiet ut quam sit amet vehicula. Donec sit amet facilisis quam. Integer mollis, urna accumsan tempor hendrerit, risus neque tincidunt neque, in aliquam elit eros quis tortor. Sed id venenatis massa, ut malesuada sem. Nam lacinia sodales tellus nec efficitur. Vestibulum fringilla nisl ac iaculis ultricies. Sed commodo imperdiet metus vitae molestie. In laoreet rutrum pretium. Aenean a enim ac lacus tincidunt pellentesque ac a tellus.</p>
	...
	<img src="https://images.unsplash.com/photo-1620694563886-c3a80ec55f41?crop=entropy&cs=srgb&fm=jpg&ixid=MnwxNDU4OXwwfDF8cmFuZG9tfHx8fHx8fHx8MTY1MDY1NDQ3Ng&ixlib=rb-1.2.1&q=85" alt="Yellow Warbler perched in a tree with white flowers. " title="Photo by Mark Olsen for Unsplash" class="editorial-image-left">
